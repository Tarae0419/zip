...
// 실제 개설 교과목 목록 엑셀(course/2026_1·2학기_학부전공_개설교과목_목록.xlsx, course/2026_1·2학기_교양.xlsx)의
// "이수구분" 값 기준. 교양 카탈로그가 2026-07-30에 추가되며 "교양"도 실제로 채워지는 값이 됐다
// (그 전엔 학부전공 목록에만 있던 값이라 항상 비어 있었다).
